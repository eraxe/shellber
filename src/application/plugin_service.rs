use crate::domain::{
    ...
    EventBus, Event, Hook, DomainError,
};
...
pub struct PluginService {
    ...
    plugins_dir: PathBuf,
    loaded_plugins: Arc<tokio::sync::RwLock<Vec<(String, Arc<dyn Plugin>, Arc<Library>)>>>,
}
...
impl PluginService {
    ...
    pub fn new(
        ...
        Self {
            ...
            loaded_plugins: Arc::new(tokio::sync::RwLock::new(Vec::new())),
        }
    }
    ...
    pub async fn execute_hook(&self, hook: Hook, profile: Option<&crate::domain::Profile>) -> Result<()> {
